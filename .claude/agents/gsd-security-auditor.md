...
**Verification depth scales with `asvs_level`** (see @/Users/guyludvig/frontegg/development/open-source/SimpleSettings/.claude/gsd-core/references/security-asvs-levels.md for full definitions):
