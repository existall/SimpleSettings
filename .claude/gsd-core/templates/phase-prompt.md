...
<!-- For checkpoint task examples and patterns, see @/Users/guyludvig/frontegg/development/open-source/SimpleSettings/.claude/gsd-core/references/checkpoints.md -->
...
See `/Users/guyludvig/frontegg/development/open-source/SimpleSettings/.claude/gsd-core/references/tdd.md` for TDD plan structure.
...
See `/Users/guyludvig/frontegg/development/open-source/SimpleSettings/.claude/gsd-core/templates/user-setup.md` for full schema and examples
...
See `/Users/guyludvig/frontegg/development/open-source/SimpleSettings/.claude/gsd-core/workflows/verify-phase.md` for verification logic.
