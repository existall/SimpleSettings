...
ones). Reference: @/Users/guyludvig/frontegg/development/open-source/SimpleSettings/.claude/gsd-core/references/edge-probe.md.
...
# — NOT the consuming project's git root — falling back to git toplevel / /Users/guyludvig/frontegg/development/open-source/SimpleSettings/.claude.
...
EDGE_PROBE_JS=$(for _c in \
  ...
  "/Users/guyludvig/frontegg/development/open-source/SimpleSettings/.claude/gsd-core/bin/lib/edge-probe.cjs" \
  "/Users/guyludvig/frontegg/development/open-source/SimpleSettings/.claude/bin/lib/edge-probe.cjs"; do
  [ -f "$_c" ] && { echo "$_c"; break; }
done)
...
requirement list). Reference: @/Users/guyludvig/frontegg/development/open-source/SimpleSettings/.claude/gsd-core/references/prohibition-probe.md — the
...
Use the SPEC.md template from @/Users/guyludvig/frontegg/development/open-source/SimpleSettings/.claude/gsd-core/templates/spec.md.
