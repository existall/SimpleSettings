...
- **Global scope**: `/Users/guyludvig/frontegg/development/open-source/SimpleSettings/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/guyludvig/frontegg/development/open-source/SimpleSettings/.claude/notes/`)
...
2. Glob `/Users/guyludvig/frontegg/development/open-source/SimpleSettings/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/Users/guyludvig/frontegg/development/open-source/SimpleSettings/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/guyludvig/frontegg/development/open-source/SimpleSettings/.claude/notes/` — works in any directory
