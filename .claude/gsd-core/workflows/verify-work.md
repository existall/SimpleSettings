...
<template>
@/Users/guyludvig/frontegg/development/open-source/SimpleSettings/.claude/gsd-core/templates/UAT.md
</template>
...
**MVP-mode UAT framing.** When `MVP_MODE=true`, follow the rules in `@/Users/guyludvig/frontegg/development/open-source/SimpleSettings/.claude/gsd-core/references/verify-mvp-mode.md`. Briefly:
...
Read and follow `/Users/guyludvig/frontegg/development/open-source/SimpleSettings/.claude/gsd-core/workflows/transition.md`.
...
- Follow @/Users/guyludvig/frontegg/development/open-source/SimpleSettings/.claude/gsd-core/workflows/diagnose-issues.md
