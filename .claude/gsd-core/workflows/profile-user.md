...
Key references:
- @/Users/guyludvig/frontegg/development/open-source/SimpleSettings/.claude/gsd-core/references/ui-brand.md (display patterns)
- @/Users/guyludvig/frontegg/development/open-source/SimpleSettings/.claude/agents/gsd-user-profiler.md (profiler agent definition)
- @/Users/guyludvig/frontegg/development/open-source/SimpleSettings/.claude/gsd-core/references/user-profiling.md (profiling reference doc)
</required_reading>
...
```bash
PROFILE_PATH="/Users/guyludvig/frontegg/development/open-source/SimpleSettings/.claude/gsd-core/USER-PROFILE.md"
...
```bash
cp "/Users/guyludvig/frontegg/development/open-source/SimpleSettings/.claude/gsd-core/USER-PROFILE.md" "/Users/guyludvig/frontegg/development/open-source/SimpleSettings/.claude/USER-PROFILE.backup.md"
```
...
✓ Stores profile at /Users/guyludvig/frontegg/development/open-source/SimpleSettings/.claude/gsd-core/USER-PROFILE.md
...
- The user-profiling reference doc at `/Users/guyludvig/frontegg/development/open-source/SimpleSettings/.claude/gsd-core/references/user-profiling.md`
...
Reference: @/Users/guyludvig/frontegg/development/open-source/SimpleSettings/.claude/gsd-core/references/user-profiling.md
...
Display: "✓ Profile written to /Users/guyludvig/frontegg/development/open-source/SimpleSettings/.claude/gsd-core/USER-PROFILE.md"
...
- options (ALL pre-selected by default):
  ...
  - "Global CLAUDE.md" -- "Add profile to /Users/guyludvig/frontegg/development/open-source/SimpleSettings/.claude/CLAUDE.md for all projects"

**If no artifacts selected:** Display "No artifacts generated. Your profile is saved at /Users/guyludvig/frontegg/development/open-source/SimpleSettings/.claude/gsd-core/USER-PROFILE.md" and jump to step 10.
...
Display: "✓ Generated /gsd-dev-preferences at /Users/guyludvig/frontegg/development/open-source/SimpleSettings/.claude/skills/gsd-dev-preferences/SKILL.md"
...
Display: "✓ Added profile section to /Users/guyludvig/frontegg/development/open-source/SimpleSettings/.claude/CLAUDE.md"
...
```bash
BACKUP_PATH="/Users/guyludvig/frontegg/development/open-source/SimpleSettings/.claude/USER-PROFILE.backup.md"
```
...
Your profile:    /Users/guyludvig/frontegg/development/open-source/SimpleSettings/.claude/gsd-core/USER-PROFILE.md
```

Then list paths for each generated artifact:
```
Artifacts:
  ✓ /gsd-dev-preferences   /Users/guyludvig/frontegg/development/open-source/SimpleSettings/.claude/skills/gsd-dev-preferences/SKILL.md
  ✓ CLAUDE.md section       <resolved claude_md_path, default ./.claude/CLAUDE.md>
  ✓ Global CLAUDE.md        /Users/guyludvig/frontegg/development/open-source/SimpleSettings/.claude/CLAUDE.md
```
