...
```
Agent(
  prompt="Read /Users/guyludvig/frontegg/development/open-source/SimpleSettings/.claude/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/guyludvig/frontegg/development/open-source/SimpleSettings/.claude/gsd-core/templates/SECURITY.md`
