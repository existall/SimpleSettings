...
The keys live in `.claude/settings.json` (project) or `/Users/guyludvig/frontegg/development/open-source/SimpleSettings/.claude/settings.json` (global) — **not** in `.planning/config.json`:
