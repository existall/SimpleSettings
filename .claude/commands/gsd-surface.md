...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `/Users/guyludvig/frontegg/development/open-source/SimpleSettings/.claude/.gsd-surface.json`
(sibling to `/Users/guyludvig/frontegg/development/open-source/SimpleSettings/.claude/.gsd-profile`) and re-stages the active skills directory in place.
Skill dirs live at `/Users/guyludvig/frontegg/development/open-source/SimpleSettings/.claude/skills/gsd-*/`.
...
(`~/.claude`), NOT the skills sub-directory (`/Users/guyludvig/frontegg/development/open-source/SimpleSettings/.claude/skills`).
...
`/Users/guyludvig/frontegg/development/open-source/SimpleSettings/.claude/skills/gsd-*/` because the `claude global` layout has `destSubpath =
...
(i.e. `/Users/guyludvig/frontegg/development/open-source/SimpleSettings/.claude/.gsd-surface.json`).
...
<execution_context>
Surface state file: `/Users/guyludvig/frontegg/development/open-source/SimpleSettings/.claude/.gsd-surface.json`
Install profile marker: `/Users/guyludvig/frontegg/development/open-source/SimpleSettings/.claude/.gsd-profile`
Skill dirs: `/Users/guyludvig/frontegg/development/open-source/SimpleSettings/.claude/skills/gsd-*/`
Engine module: `/Users/guyludvig/frontegg/development/open-source/SimpleSettings/.claude/gsd-core/bin/lib/surface.cjs`
Cluster definitions: `/Users/guyludvig/frontegg/development/open-source/SimpleSettings/.claude/gsd-core/bin/lib/clusters.cjs`
</execution_context>
