...
```
Agent(
  prompt="Read /Users/guyludvig/frontegg/development/open-source/SimpleSettings/.codex/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/guyludvig/frontegg/development/open-source/SimpleSettings/.codex/gsd-core/templates/SECURITY.md`
