...
```
Agent(
  prompt="Read /Users/guyludvig/frontegg/development/open-source/SimpleSettings/.codex/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/guyludvig/frontegg/development/open-source/SimpleSettings/.codex/gsd-core/templates/VALIDATION.md`
