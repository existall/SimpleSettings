...
INSTALL_JS_GLOBAL="/Users/guyludvig/frontegg/development/open-source/SimpleSettings/.codex/gsd-core/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node /Users/guyludvig/frontegg/development/open-source/SimpleSettings/.codex/gsd-core/bin/install.js --global --<runtime>
```
Then exit.
