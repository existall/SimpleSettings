...
<required_reading>
@/Users/guyludvig/frontegg/development/open-source/SimpleSettings/.codex/gsd-core/references/ai-frameworks.md
@/Users/guyludvig/frontegg/development/open-source/SimpleSettings/.codex/gsd-core/references/ai-evals.md
</required_reading>
...
```markdown
Read /Users/guyludvig/frontegg/development/open-source/SimpleSettings/.codex/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "/Users/guyludvig/frontegg/development/open-source/SimpleSettings/.codex/gsd-core/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read /Users/guyludvig/frontegg/development/open-source/SimpleSettings/.codex/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read /Users/guyludvig/frontegg/development/open-source/SimpleSettings/.codex/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read /Users/guyludvig/frontegg/development/open-source/SimpleSettings/.codex/agents/gsd-eval-planner.md for instructions.
