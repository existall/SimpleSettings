...
The keys live in `.codex/settings.json` (project) or `/Users/guyludvig/frontegg/development/open-source/SimpleSettings/.codex/settings.json` (global) — **not** in `.planning/config.json`:
